...
$$
\hat{y} = \beta_0 + \beta_1x + \epsilon_i, \text{ where } \epsilon_i\sim{\text{N}}(0,\sigma)
$$
...
$$
\hat{y} = \beta_0 + \beta_1\text{GroupB}+ \epsilon_i, \text{ where } \epsilon_i\sim{\text{N}}(0,\sigma).
$$
...
**For Questions 4 and 5,recall that in Chapter 3 practice problems, we worked with a dataset pertaining to a sample of 200 high school seniors. Data were collected from student responses to the High School and Beyond Survey.** 


We'll continue to work with those data, this time using theory based on the ordinary regression model to perform inference. 
...
![M1 Output](Ch4_1.png){#id .class width=110% height=110%}
...
![M2 Output](Ch4_1.png){#id .class width=110% height=110%}
