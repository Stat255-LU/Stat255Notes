...
P1 <- ggplot(data=dfA, aes(x=x1, y=y1)) + geom_point() + ylim(c(0,40)) + xlab("x") + ylab("y") + stat_smooth(method="lm", se=FALSE) + ggtitle("Scenario A")
P2 <- ggplot(data=dfB, aes(x=x, y=y)) + geom_point() + ylim(c(0,40)) + stat_smooth(method="lm", se=FALSE) + ggtitle("Scenario B")
grid.arrange(P1, P2, ncol=2) 
```
