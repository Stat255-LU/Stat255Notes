...
&=\frac{\frac{`r round(SSR_M_House_price_sqft_wf,2)` - `r round(SSR_M_House_price_sqft,2)`}{2-1}}{\frac{`r round(SSR_M_House_price_sqft_wf,2)`}{200-(2+1)}} \\  
...
\begin{aligned}
F &= \frac{\frac{\text{SSR}_{\text{Reduced}}-\text{SSR}_{\text{Full}}}{p-q}}{\frac{\text{SSR}_{\text{Full}}}{n-(p+1)}} \\
&=\frac{\frac{`r round(SSR_M_House_price_sqft_wf_age,2)` - `r round(SSR_M_House_price_sqft_wf,2)`}{3-2}}{\frac{`r round(SSR_M_House_price_sqft_wf,2)`}{200-(3+1)}} \\  
