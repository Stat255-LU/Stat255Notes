...
-   Computational learing outcomes C and D will be emphasized throughout the course. Outcomes A and B especially pertain to Chapter 1, but will also be used throughout the course.
...
Houses <- home_prices |> mutate(price=10^price/1000 |> round(0),
                          ...
                          select(ID, price, sqft_living, waterfront, condition, sqft_lot, bedrooms, bathrooms, yr_built)
...
The histograms show the distribution of quiz scores in three different statistics classes.
