...
34. Identify situations where it is appropriate to use a logistic regression model.\
35. Calculate probabilities and odds using logistic regression.\
36. Interpret logistic regression coefficients in context.\
37. Draw conclusions about logistic regression models based on graphical representations of data.   
